"""Full streaming implementation — only loaded in the UI process.

This module is imported by stream_hook.py's find_spec ONLY when
the target module (openpilot.system.ui.lib.application) is being
imported.  No other openpilot process ever touches this file.
"""
...
# ---------------------------------------------------------------------------
# Loader wrapper + entry point called from stream_hook.py
# ---------------------------------------------------------------------------
...
def handle_ui_import(module_name):
    """Called from stream_hook._SF.find_spec when the UI module is imported.

    Returns a ModuleSpec with our wrapping loader, or None.
    """
