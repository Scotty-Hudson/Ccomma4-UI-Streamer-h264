...
# Uses the battle-tested approach from Peter's comma:
#   - sys.path.insert for clean import
...
# ---------------------------------------------------------------------------
capture = '        if self._ui_stream is not None and self._render_texture is not None:\n            self._ui_stream.capture_frame(self, int(os.getenv("STREAM_QUALITY", "50")), int(os.getenv("STREAM_FPS", "20")))\n'
